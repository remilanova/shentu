...
// ---- tiny local UI helpers (за да не зависим от други компоненти)
...
export default function Home() {
  ...
  // ---- demo callback (по желание)
  function submitMiniCard(e: React.FormEvent) {
    e.preventDefault()
    // тук можеш да валидираш и да пренасочиш към пълния въпросник
    // например: if(earlyConsent) router.push('/questionnaire')
    ...
    <div className="min-h-screen bg-[#F7F5F2] text-[#3F3A34]">
      ...
      <main className="max-w-6xl mx-auto px-4 py-8">
        <Section title="Начало">
          <Card>
            <p>Това е минимална работеща начална страница. Оттук ще надграждаме дизайна.</p>
          </Card>
        </Section>
